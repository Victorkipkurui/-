...
import myphoto5 from '../assets/images/Managing security Risks.jpg';
...
const Certifications = () => {
  ...
  return (
    <div ref={ref}>
      <div>
      <h1 className="text-center text-gray-900 text-3xl font-semibold my-6">CERTIFICATIONS</h1>
      </div>
      <div className={`grid grid-cols-3 grid-rows-2 px-14 py-6 gap-4 transition-transform duration-700 ease-in-out ${isVisible ? 'animate-slideInUp' : 'transform translate-y-10 opacity-0'}`}>
      ...
      <div>
        <div className='text-center py-6'>
          <h2 className="text-center text-gray-900 text-3xl font-semibold">Download My Resume Here</h2>
        </div>
        <div className='flex items-center justify-center py-6'>
          <button className='bg-blue-700 p-3 px-5 rounded-md text-white flex items-center space-x-2 hover:bg-blue-800 hover:scale-110 transform transition-transform duration-300 ease-in-out' onClick={handleDownload} >
            <span>Resume</span>
            <FaDownload />
          </button>
        </div>
