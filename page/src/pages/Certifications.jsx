...
const Certifications = () => {
  ...
  <div ref={ref}>
    ...
    <div className={`grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 px-4 sm:px-10 md:px-14 py-6 transition-transform duration-700 ease-in-out ${isVisible ? 'animate-slideInUp' : 'transform translate-y-10 opacity-0'}`}>
